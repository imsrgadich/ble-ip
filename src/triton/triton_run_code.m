function triton_run_code(job_id,ref_map_flag)
...
sprintf('saving the workspace to triton_files/workspace/calibration_points_old/%d.mat\n',job_id)
path_string = sprintf('/m/cs/work/gadichs1/ip/ble-ip-helvar/triton_files/workspace/calibration_points_old/%d.mat',job_id);
save(path_string)
