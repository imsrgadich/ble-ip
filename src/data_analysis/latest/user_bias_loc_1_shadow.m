[t, id_beacon, y_beacon, ~, ~, ~, ~, ~, ~,~,~,mac_beacon] = load_data('2017.09.08.13.58.33.txt');
...
[H, pValue, W] = swtest(y_helvar_8b3f_west)
[H, pValue, W] = swtest(y_helvar_8af5_west)
[H, pValue, W] = swtest(y_helvar_8af4_west)
[H, pValue, W] = swtest(y_helvar_8b32_west)
[H, pValue, W] = swtest(y_helvar_8b44_west)
[H, pValue, W] = swtest(y_helvar_8cd1_west)
[H, pValue, W] = swtest(y_helvar_8ca0_west)
...
p = signrank(y_helvar_8b3f_west,y_helvar_8b3f_wo_user)
p = signrank(y_helvar_8af5_west,y_helvar_8af5_wo_user)
p = signrank(y_helvar_8af4_west,y_helvar_8af4_wo_user)
p = signrank(y_helvar_8b32_west,y_helvar_8b32_wo_user)
p = signrank(y_helvar_8b44_west,y_helvar_8b44_wo_user)
p = signrank(y_helvar_8cd1_west,y_helvar_8cd1_wo_user)
p = signrank(y_helvar_8ca0_west,y_helvar_8ca0_wo_user)